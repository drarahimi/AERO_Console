C===========================================================================
C     LAPACK and BLAS routines from lapack-release-lapack-3.10
C     H.Youngren 3/2023
C      
C     Selected routines to support LU decompose and back substitution using:
C         sgetrf, sgetrs, dgetrf, dgetrs 
C===========================================================================
